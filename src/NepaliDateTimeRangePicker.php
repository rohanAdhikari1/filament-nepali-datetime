...
class NepaliDateTimeRangePicker extends Field implements HasAffixActions
{
    ...
    public function maxDate(CarbonInterface | NepaliDateInterface | string | Closure | null $date): static
    {
        $this->maxDate = $date;
    ...
    public function getExtraTriggerAttributes(): array
    {
        ...
        foreach ($this->extraTriggerAttributes as $extraTriggerAttributes) {
            $temporaryAttributeBag = $temporaryAttributeBag->merge((array) $this->evaluate($extraTriggerAttributes), escape: false);
        }
    ...
    // TODO: locale support en and np only
